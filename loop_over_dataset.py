...
while True:
    try:
        ...
        if 'measure_detection_performance' in exec_list:
            ...
            det_performance = eval.measure_detection_performance(detections, frame.laser_labels, valid_label_flags, configs_det)     
        else:
            ...
            det_performance = load_object_from_file(results_fullpath, data_filename, 'det_performance_' + configs_det.arch + '_' , cnt_frame)    
